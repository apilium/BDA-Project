...
We chose to use BRMS for modeling, due to ...
...
### WIP: Hierarchical model

In hierarchical model, we choose age and sex as hyperparameters.  
...
HIERARCHICAL: Scrap code left from previous implementation
